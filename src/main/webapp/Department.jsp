...
<div class="container">
    ...
    <form action="">
        ...
        <div class="loc">
            <span class="bi bi-geo-alt icon-loc"></span>
        </div>
        <input type="text" name="location" placeholder="  Enter Your Location" class="inp-loc">
